 ...
 *
 *  $Id: default_resource.h 2644 2015-08-26 16:03:32Z mesnierp $
 *
...
public:
  ...
  virtual bool refresh_IORTable (void) const;
...
protected:
  ...
  /// Specifies the initial setting of the IORTable's dynamic refresh
  /// flag. May be overridden by IORTable API
  bool refresh_IORTable_;
