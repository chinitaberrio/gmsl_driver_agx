 ...
 *
 *  $Id: Transport_Acceptor.h 2644 2015-08-26 16:03:32Z mesnierp $
 *
...
public:
  ...
  /**
   * Return true if the acceptor refreshed one or more profiles
   * Default impl returns false.
   */
  virtual bool refresh (TAO_MProfile &mp);
