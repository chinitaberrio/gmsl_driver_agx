 ...
 *
 *  $Id: IOR_Table_Impl.h 2646 2015-08-28 00:38:05Z mesnierp $
 *
...
public:
  ...
  /// Constructor
  TAO_IOR_Table_Impl (TAO_ORB_Core &oc);

  virtual bool async_available (void) { return false; }

  bool refresh (ACE_CString &ior);
  ...
  virtual void refresh (CORBA::Boolean enable);
  //@}
