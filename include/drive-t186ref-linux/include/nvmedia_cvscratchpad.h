...
#ifndef NVMEDIA_CVSCRATCHPAD_H
#define NVMEDIA_CVSCRATCHPAD_H
 ...
 * \param[out] version  A pointer to a structure that the function fills with
 *                      version information.
