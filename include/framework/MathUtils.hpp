...
inline constexpr float32_t secs2MicroSecs(float32_t sec)
{
    return 1000000.0f * sec;
}

//------------------------------------------------------------------------------
// Converts seconds to microseconds
inline constexpr float64_t secs2MicroSecs(float64_t sec)
{
    return 1000000.0 * sec;
}
